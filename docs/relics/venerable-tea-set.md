...
description: "Whenever you enter a Rest Site, start the next combat with an additional 2 Energy. Common Relic relic."
---

# Venerable Tea Set

<div class="wiki-entity-hero" markdown="1">
<a class="wiki-image-link" href="/media/relics/venerable-tea-set.webp" target="_blank" rel="noopener" aria-label="View full image: Venerable Tea Set" title="View full image: Venerable Tea Set"><img class="wiki-image wiki-image--relic-detail" src="/media/relics/venerable-tea-set.webp" alt="Venerable Tea Set" loading="lazy" decoding="async"></a>
